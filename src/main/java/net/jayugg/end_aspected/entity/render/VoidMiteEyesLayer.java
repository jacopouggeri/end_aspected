...
@OnlyIn(Dist.CLIENT)
public class VoidMiteEyesLayer<T extends Entity, M extends VoidMiteModel<T>> extends AbstractEyesLayer<T, M> {
    private static final RenderType RENDER_TYPE = RenderType.makeType(
            "voidmite_eyes",
            DefaultVertexFormats.ENTITY,
            GL11.GL_QUADS, 256,
            RenderType.State.getBuilder()
                    .texture(new RenderState.TextureState(EndAspected.prefix("textures/entity/voidmite_eyes.png"), false, false))
    ...
    public VoidMiteEyesLayer(IEntityRenderer<T, M> rendererIn) {
        super(rendererIn);
    }

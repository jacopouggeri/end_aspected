...
public class VoidVineTreeDecorator extends TreeDecorator {
    public static final Codec<VoidVineTreeDecorator> CODEC;
    public static final VoidVineTreeDecorator DECORATOR = new VoidVineTreeDecorator();
    ...
    protected void placeVine(IWorldWriter world, BlockPos pos, BooleanProperty vineProperty, Set<BlockPos> decorations, MutableBoundingBox mutableBoundingBox) {
        this.func_227423_a_(world, pos, ModBlocks.VOID_VINE.get().getDefaultState().with(vineProperty, true), decorations, mutableBoundingBox);
    }
        ...
        leaves.forEach((leafBlock) -> {
            if (rand.nextInt(4) == 0) {
                ...
                if (Feature.isAirAt(reader, blockpos)) {
                    this.placeVineWithDirection(reader, blockpos, VoidVineBlock.EAST, decorations, mutableBoundingBox);
                }
            }
            ...
            if (rand.nextInt(4) == 0) {
                ...
                if (Feature.isAirAt(reader, blockpos1)) {
                    this.placeVineWithDirection(reader, blockpos1, VoidVineBlock.WEST, decorations, mutableBoundingBox);
                }
            }
            ...
            if (rand.nextInt(4) == 0) {
                ...
                if (Feature.isAirAt(reader, blockpos2)) {
                    this.placeVineWithDirection(reader, blockpos2, VoidVineBlock.SOUTH, decorations, mutableBoundingBox);
                }
            }
            ...
            if (rand.nextInt(4) == 0) {
                ...
                if (Feature.isAirAt(reader, blockpos3)) {
                    this.placeVineWithDirection(reader, blockpos3, VoidVineBlock.NORTH, decorations, mutableBoundingBox);
                }
            }

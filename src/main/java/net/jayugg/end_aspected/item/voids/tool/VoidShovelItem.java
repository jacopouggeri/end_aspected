...
public class VoidShovelItem extends VoidToolItem {
    ...
    public VoidShovelItem(float attackDamageIn, float attackSpeedIn, VoidItemTier tier, Properties properties) {
        super(attackDamageIn, attackSpeedIn, EFFECTIVE_ON, tier, properties.addToolType(ToolType.SHOVEL, tier.getHarvestLevel()));
    }

    @Override
    public boolean canConsume(ItemStack stack) {
        return stack.getItem() instanceof ShovelItem || stack.getItem() instanceof VoidShovelItem;
    }

...
public class VoidShovelItem extends VoidToolItem {
    ...
    public VoidShovelItem(VoidItemTier tier, float attackDamageIn, float attackSpeedIn, Properties properties) {
        super(tier, attackDamageIn, attackSpeedIn, EFFECTIVE_ON, properties.addToolType(ToolType.SHOVEL, tier.getHarvestLevel()));
    }
